...
(function($){
    ...
    function YoxThumbs(container, options)
    {
        ...
        var currentImageIndex = 0,
		    foundThumbnails = containerIsAnchor ? container : container.find("a:has(pic_block)");
        ...
        if (options.thumbsOpacity)
        {
            ...
            container.delegate("a:has(pic_block)", "mouseenter.yoxthumbs", function(e){
            ...
            .delegate("a:has(pic_block)", "mouseout.yoxthumbs", function(e){
                if (self.currentSelectedIndex === undefined || 
                    $(e.currentTarget).data("yoxthumbs").imageIndex != self.currentSelectedIndex)
        ...
        if (options.onClick)
        {
			if (containerIsAnchor)
				...
				container.delegate("a:has(pic_block)", "click.yoxthumbs", function(e){
        ...
        function createThumbnail(imageData, viewIndex)
        {
            ...
            var thumbImage = jQuery("<pic_block>", {
        ...
        this.unload = function(dataKey)
        {
            ...
            container.undelegate("a:has(pic_block)", "click.yoxthumbs");
